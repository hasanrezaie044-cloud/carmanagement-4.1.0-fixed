    ...
    LazyColumn(
        ...
        item {
            SurfaceCard {
                ...
                Spacer(Modifier.height(10.dp))
                // یادآوری تعویض روغن دیگر از این بازه استفاده نمی‌کند — کیلومتر فعلی/بعدی
                // مستقیماً از تب «تعمیرات» تنظیم می‌شود (دقیق‌تر و بر اساس سرویس‌های واقعی).
                Text(
                    "برای تعویض روغن، کیلومتر فعلی و کیلومتر بعدی از تب «تعمیرات» تنظیم می‌شود.",
